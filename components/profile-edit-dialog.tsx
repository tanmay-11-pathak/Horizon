...
export function ProfileEditDialog({ children, initialData }: { children?: React.ReactNode; initialData?: ProfileEditData }) {
  const id = useId();
    ...
    <Dialog>
      ...
      <DialogContent className="flex flex-col gap-0 overflow-y-visible p-0 sm:max-w-lg [&>button:last-child]:top-3.5">
        ...
        <div className="overflow-y-auto">
          <ProfileBg defaultImage={initialData?.bannerUrl || "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=2564&auto=format&fit=crop"} />
          <Avatar defaultImage={initialData?.avatarUrl || "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=256&q=80"} />
